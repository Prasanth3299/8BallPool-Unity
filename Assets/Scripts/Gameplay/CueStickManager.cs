...
namespace RevolutionGames.Game
{
    public class CueStickManager : MonoBehaviour
    {
        ...
        private CueBallCollisionHandler cueBallCollisionHandler;
        private ForceSlider forceUpdater;
        ...
        void Start()
        {
            ...
            forceUpdater = gameManager.hudManager.forceUpdater.GetComponent<ForceSlider>();
        ...
        IEnumerator ResetGameFlag()
        {
            ...
            {
                gameManager.CurrentGameState = GameManager.GameState.isStrikeDone;
            }
            else
            {
                gameManager.CurrentGameState = GameManager.GameState.isItCueballBreakDone;
            }
        }
