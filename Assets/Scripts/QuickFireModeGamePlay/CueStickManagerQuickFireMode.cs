...
{
    public class CueStickManagerQuickFireMode : MonoBehaviour
    {
        ...
        public HudManagerQuickFireMode hudManagerQuickFire;
        public QuickFireModeManager quickFireModeManager;
        private BoardManagerQuickFireMode boardManager;
        public CueStickDataManager cueStickDataManager;
        private CueBallManagerQuickFireMode cueBallManager;
        private CueBallCollisionHandlerQuickFireMode cueBallCollisionHandler;
        private ForceSliderQuickFireMode forceUpdater;
        ...
        public int consecutivePottedBallsCount;
        ...
        void Start()
        {
            ...
            forceUpdater = gameManager.hudManager.forceUpdater.GetComponent<ForceSliderQuickFireMode>();
        ...
        IEnumerator ResetGameFlag()
        {
            ...
            {
                gameManager.CurrentGameState = GameManagerQuickFire.GameState.isStrikeDone;
            }
            else
            {
                gameManager.CurrentGameState = GameManagerQuickFire.GameState.isItCueballBreakDone;
            }
        }
        ...
        {
            /*print("pottedBallcount" + boardManager.pottedBallcount);
            print("count" + boardManager.pottedBalls.Count);
            int pottedBallsCount = boardManager.pottedBalls.Count;
            int pottedQuickPlayBallsCount = boardManager.pottedQuickPlayBalls.Count;
            //print("pottedQuickPlayBallsCount" + pottedQuickPlayBallsCount);
            if (pottedQuickPlayBallsCount < pottedBallsCount)
            {
                boardManager.pottedQuickPlayBalls = boardManager.pottedBalls;
            }
            else
            {
                boardManager.pottedQuickPlayBalls.Clear();
                boardManager.pottedBalls.Clear();
            }
            if(pottedQuickPlayBallsCount==5)
            {
                print("five balls potted");
                boardManager.pottedQuickPlayBalls.Clear();
                boardManager.pottedBalls.Clear();
            }*/
            //print("pottedQuickPlayBallsCount"+ pottedQuickPlayBallsCount);
            //print("potted count"+ pottedBallsCount);
            //if (cueBall.velocity.magnitude <= 0.01f)
            {
                ...
                int ballPottedCointList = boardManager.pottedBalls.Count;
      

                if (ballPottedCointList > consecutivePottedBallsCount)
                {
                    consecutivePottedBallsCount = ballPottedCointList;
                ...
                else
                {
                    ...
                    boardManager.pottedBalls.Clear();
                    consecutivePottedBallsCount = 0;
                    hudManagerQuickFire.ClearPlayerPottedBallsDisplay();
                  
                }
                if(ballPottedCointList % 5==0&& ballPottedCointList != 0)
                {
                    quickFireModeManager.FiveConsecutivePottedFunction();
                   
                }

               // ballPottedCount = boardManager.pottedBalls.Count

                hudManagerQuickFire.UpdatePlayerPottedBallsListDisplay();
                //print("enable");
