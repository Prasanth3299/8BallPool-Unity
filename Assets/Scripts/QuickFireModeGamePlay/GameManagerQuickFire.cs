...
{
    public class PlayerQuickFireMode
    {
        public string name = "";
    ...
    public class GameManagerQuickFire : MonoBehaviour
    {
        ...
        public CueStickManagerQuickFireMode cueStickManager;
        public CueBallManagerQuickFireMode cueBallManager;
        public CueBallCollisionHandlerQuickFireMode cueBallCollisionHandler;
        public HudManagerQuickFireMode hudManager;
        public GameRules gameRules;
        public BoardManagerQuickFireMode boardManager;
        ...
        {
            isGameOn, isGamePaused, isReadyForStrike, isItResetCueballOn, isItCueballBreak, isGameOver, isStrikeDone,
