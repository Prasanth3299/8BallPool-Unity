...
{
    public class CanvasInputPositionHandlerQuickFireMode : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnPointerDown(PointerEventData pointerEventData)
        {
            ...
            if ((hudManager.gameManager.CurrentGameState == GameManagerQuickFire.GameState.isItResetCueballOn ||
                hudManager.gameManager.CurrentGameState == GameManagerQuickFire.GameState.isItCueballBreak) && cueBallInHandSprite.bounds.Contains(mousePos))
            {
