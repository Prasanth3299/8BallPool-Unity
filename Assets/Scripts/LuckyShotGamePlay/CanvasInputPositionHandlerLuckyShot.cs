...
{
    public class CanvasInputPositionHandlerLuckyShot : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnPointerDown(PointerEventData pointerEventData)
        {
            ...
            if ((hudManager.gameManager.CurrentGameState == GameManagerLuckyShot.GameState.isItResetCueballOn ||
                hudManager.gameManager.CurrentGameState == GameManagerLuckyShot.GameState.isItCueballBreak) && cueBallInHandSprite.bounds.Contains(mousePos))
            {
