...
namespace RevolutionGames.Data
{
    ...
    class CueStickLocalDataLuckyShot //PlayerPrefs data
    {
    ...
    class CueStickPropertiesLuckyShot //APIData
    {
        private int force = 0;
        private int spin = 0;
        private int aim = 0;
        ...
        public CueStickPropertiesLuckyShot(int force, int aim, int spin, int time, int charge)
        {
            this.force = force;
            this.aim = aim;
            this.spin = spin;
    ...
    class CueStickLevelLuckyShot
    {
        ...
        public CueStickLevelLuckyShot(int levelNumber, int maxSubLevel, int currentSubLevel,
    ...
    class CueStickLuckyShot //APIData
    {
        ...
        public CueStickLuckyShot(Sprite image, string name, CueStickProperties cueStickProperties)
        {
            this.image = image;
            this.name = name;
        ...
        public CueStickLuckyShot(Sprite image, string name, string category, string city, string price, long priceInNumbers, string rechargePrice, long rechargePriceInNumbers,
    ...
    public class CueStickDataManagerLuckyShot : MonoBehaviour
    {
